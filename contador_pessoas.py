...
cv2.namedWindow("Olho de Sauron", cv2.WINDOW_NORMAL)
cv2.resizeWindow("Olho de Sauron", 1280, 720)

print("🚨 SISTEMA ANTI-CELULAR ATIVADO! Ninguém escapa.")
...
while True:
    ...
    if tem_celular_na_tela:
        ...
        cv2.putText(frame_com_ia, "CELULAR DETECTADO!", (100, 150), cv2.FONT_HERSHEY_DUPLEX, 2, (0, 0, 255), 5)
        cv2.putText(frame_com_ia, "MULTA APLICADA!", (100, 220), cv2.FONT_HERSHEY_DUPLEX, 1.5, (0, 255, 255), 4)

    cv2.imshow("Olho de Sauron", frame_com_ia)
